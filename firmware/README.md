...
* PY32F030
    * PY32F030x4(16KB Flash/2KB RAM), PY32F030x6(32KB Flash/4KB RAM), PY32F030x7(48KB Flash/6KB
      RAM), PY32F030x8(64KB Flash/8KB RAM)
* PY32F072
    * PY32F072xB(128KB Flash/16KB RAM)

**Note**

There is high probability that PY32F002A, PY32F003 and PY32F030 share the same core, you can treat
them all as PY32F030 in coding and programming.
...
* SEGGER J-Link Software and Documentation
  pack [https://www.segger.com/downloads/jlink/](https://www.segger.com/downloads/jlink/)
...
from [Arm GNU Toolchain Downloads](https://developer.arm.com/downloads/-/arm-gnu-toolchain-downloads)
according to your pc architecture, extract the files
...
from [J-Link / J-Trace Downloads](https://www.segger.com/downloads/jlink/).
...
Read
more: [https://wiki.segger.com/J-Link_Device_Support_Kit](https://wiki.segger.com/J-Link_Device_Support_Kit)
...
In Ubuntu, .profile will take care of the PATH, run `source ~/.profile` to make pyocd command
available
...
* **USE_LL_LIB** Puya provides two sets of library, HAL and LL, set `USE_LL_LIB ?= y` to use LL
  instead of HAL.
* **ENABLE_PRINTF_FLOAT** set it to `y` to `-u _printf_float` to link options. This will increase
  the binary size.
...
More examples can be found in *Examples* folder, copy and replace the files under *User* folder to
try different examples.

# Links

* Puya Product Page(Datasheet & SDK
  download): https://www.puyasemi.com/cpzx3/info_267_aid_242_kid_235.html

## Pinout

| MCU Pin | Function | Features                     | Use       |
|---------|----------|------------------------------|-----------|
| 2       | PA4      | ADC_IN4                      | V_FAN_OUT |
| 2       | PA10     | TIM1_CH3                     |           |
| 3       | PA3      | TIM1_CH1, ADC_IN3            |           |
| 4       | PA14     | SWCLK                        |           |
| 4       | PB3      | TIM1_CH2                     |           |
| 5       | PA13     | SWDIO, TIM1_CH2              |           |
| 6       | NRST     | MCO, NRST                    |           |
| 6       | PA2      | ADC_IN2                      |           |
| 7       | PA1      | TIM1_CH4, TIM1_CH2N, ADC_IN1 |           |
